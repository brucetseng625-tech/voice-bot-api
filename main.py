...
def get_ai_response(user_text):
    ...
    # 4. Identity & Developer Info
    if any(x in text_lower for x in ["誰是", "你是誰", "自我介紹", "名字"]):
        return "我是你的專屬 3D 虛擬助理「緋雪」喔！我可以陪你聊天、聽你訴苦、給你滿滿的正能量～", "happy"
    ...
    if any(x in text_lower for x in ["累", "辛苦", "加班", "壓力", "煩"]):
    ...
    # 8. Casual chat fallbacks (semi-dynamic based on state)
    defaults = [
